		...
		else if (leftOperandEndPosition > rightOperandEndPosition)
		{
			...
			if (gapExtension)
			{
				...
				if (leftStartBit == ZERO_GAP_WORD)
				{
					...
					vector<int> result = alignRightWithLeft(leftOperandEndPosition,rightOperandIndex,rightOperandEndPosition,rightOperand,compressedResult,false);
				...
				{
					vector<int> result = alignRightWithLeft(leftOperandEndPosition,rightOperandIndex,rightOperandEndPosition,rightOperand,compressedResult,true);
					rightOperandIndex = result[0];
					rightOperandEndPosition = result[1];
					if (leftOperandEndPosition == rightOperandEndPosition)
					{
		...
		}else if (leftOperandEndPosition < rightOperandEndPosition)
		{
			if (gapExtension)
			{
				...
				if (rightStartBit == ZERO_GAP_WORD)
				{
					...
					setValueOnCompressedWord(resultGap,compressedResult);
					vector<int> result = alignLeftWithRight(rightOperandEndPosition,leftOperandIndex,leftOperandEndPosition,leftOperand,compressedResult,false);
				...
				{
					vector<int> result = alignLeftWithRight(rightOperandEndPosition,leftOperandIndex,leftOperandEndPosition,leftOperand,compressedResult,true);
					leftOperandIndex = result[0];
					leftOperandEndPosition = result[1];
					if (leftOperandEndPosition == rightOperandEndPosition)
					{
...
vector<int> WAHStructure::alignRightWithLeft( int leftOpEndPos,int rightOpIndex,int rightOpEndPos,vector<unsigned long int> &rightOperand,vector<unsigned long int> &resultVector,bool longerOperand )
{
	vector<int> result;
	int indexVal=0;
	int opEndPos = 0;
...
vector<int> WAHStructure::alignLeftWithRight( int rightOpEndPos,int leftOpIndex,int leftOpEndPos,vector<unsigned long int> &leftoperand,vector<unsigned long int> &resultVector,bool longerOperand )
{
	vector<int> result;
	int indexVal=0;
	int opEndPos = 0;
