...
{
	TestUniqueBitmapCreation(CreateDataSource("intVal_single_data","intVal_single_metadata","intVal_100000"));
}
...
WrapDataSource * TestRangeSplitter::CreateDataSource(string datafile,string metadFile,string filename)
{
