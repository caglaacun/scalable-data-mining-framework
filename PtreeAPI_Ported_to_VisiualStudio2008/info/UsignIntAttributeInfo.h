...
#ifndef _UsignIntAttributeInfo_H
#define	_UsignIntAttributeInfo_H
...
class UsignIntAttributeInfo : public IntAttributeInfo{
public:
	UsignIntAttributeInfo();
	UsignIntAttributeInfo(int lower, int upper);
	~UsignIntAttributeInfo();
